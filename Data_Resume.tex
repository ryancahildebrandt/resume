...
%------------------------------------------------
\runsubsection{TekSystems for Google CCAI}
\descript{| Data Designer \& NLP Specialist}

\descript{Senior Engineer}
\location{Jun 2022 - Present | Remote}
...
\descript{Data Designer -- Contract}
\location{Jun 2021 - Jun 2022 | Remote}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
%{\footnotesize \textit{\textbf{(Advanced Regression, SEM/MLM, Mediation/Moderation)}}} \textbullet{} 
