...
\href{https://rcah.xyz}{Website} \href{https://github.com/ryancahildebrandt}{Github} \href{https://codeberg.org/ryancahildebrandt}{Codeberg} \href{https://linkedin.com/in/rcah}{LinkedIn} \href{https://researchgate.net/profile/Ryan-Hildebrandt}{ResearchGate} 

ryancahildebrandt@gmail.com | Corning, New York\end{center}


\section*{Work Experience}

\noindent
\textbf{Natural Language Data Scientist \& ML Engineer}
\noindent
\textit{KForce for Public Consulting Group} \hfill 2026-06 - Present
\begin{itemize}

\item Create data ontologies and knowledge graphs based on domain-specific frameworks and client needs.
\item Engineer recommendation systems for academic skill proficiency using standardized assessment scores and teacher-written evaluations.
\item Train custom classifier and entity extraction models to annotate natural language data.
\end{itemize}

\noindent
\textbf{Senior CCAI Engineer: ML/AI \& NLP Specialist}
\noindent
\textit{Botcopy} \hfill 2024-06 - 2024-04
\begin{itemize}

\item Engineer NLP analytics pipelines to extract insights from conversational data and improve on Google's native analytics
\item Test and evaluate generative models for use across conversational agents, aligning model characteristics with client requirements
\item Build, deploy, and optimize both stateful and generative Google CCAI agents in line with client needs
\end{itemize}

\noindent
\textbf{Lead Engineer: ML/AI, NLP, \& Analytics Specialist}
\noindent
\textit{TekSystems for Google CCAI} \hfill 2022-06 - 2024-06
\begin{itemize}
...
\textit{R, Python, Ruby, SQL, Golang, NoSql Databases, Vector Databases, Julia, Git, Shell, Linux/Unix, Windows, Google Cloud Platform}
...
\noindent
\textbf{\href{https://github.com/ryancahildebrandt/aozora\_corpus}{aozora\_corpus}}
...
\noindent
\textbf{\href{https://github.com/ryancahildebrandt/c2g}{c2g}}
...
\noindent
\textbf{Speech Processing (EN \& JP)}:\textit{Speech intelligibility, Phonology, Emotional word characteristics}

\noindent
\textbf{Bilingualism}:\textit{Language acquisition, L2 phoneme processing}

\noindent
\textbf{Natural Language Processing}:\textit{Word \& sentence embedding, Unsupervised learning, Document classification}
...
\noindent
\textbf{Data Science \& Statistics}:\textit{Natural Language Processing Specialization, Feature Selection for Machine Learning, Deep Learning A-Z: Hands-On Artificial Neural Networks, Causal Data Science with Directed Acyclic Graphs, Bayesian Statistics, Graph Theory}

\noindent
\textbf{Google Cloud Platform}:\textit{Creating Business Value with Data and Looker Specialization, Customer Experiences with Contact Center AI - Dialogflow ES \& CX Specializations, From Data to Insights with Google Cloud Learning Path, Machine Learning on Google Cloud Learning Path}

\noindent
\textbf{Data Science Libraries \& Languages}:\textit{TensorFlow Developer Specialization, TensorFlow: Advanced Techniques Specialization, Complete Time Series Analysis Bootcamp in R, Master SQL for Data Science}
